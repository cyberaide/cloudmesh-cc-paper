...
\begin{itemize}
\item
  \mintinline{bash}|?directory=name|
\item
  \mintinline{bash}|?archive=name.tar.gz|
\item
  \mintinline{bash}|?archive=name.tgz|
\item
  \mintinline{bash}|?archive=name.xz|
\item
  \mintinline{bash}|?yaml=name|
\end{itemize}
