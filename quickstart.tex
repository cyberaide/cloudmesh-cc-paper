...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{git}\NormalTok{ clone https://github.com/cloudmesh/cloudmesh{-}cc.git}
\BuiltInTok{cd}\NormalTok{ cloudmesh{-}cc}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{cms}\NormalTok{ cc start }\AttributeTok{{-}{-}reload}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{mkdir} \AttributeTok{{-}p}\NormalTok{ /tmp/workflow{-}example}
\FunctionTok{cp}\NormalTok{ tests/workflow{-}example/workflow{-}example.yaml /tmp/workflow{-}example}
\FunctionTok{cp}\NormalTok{ tests/workflow{-}example/}\PreprocessorTok{*}\NormalTok{.sh /tmp/workflow{-}example}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{create-tar-archive-file}{%
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tar} \AttributeTok{{-}C}\NormalTok{ /tmp/workflow{-}example }\AttributeTok{{-}cf}\NormalTok{ workflow{-}example.tar .}
\end{Highlighting}
\end{Shaded}
...
\ExtensionTok{curl} \AttributeTok{{-}X} \StringTok{\textquotesingle{}POST\textquotesingle{}} \DataTypeTok{\textbackslash{}}
  \StringTok{\textquotesingle{}http://127.0.0.1:8000/workflow?archive=workflow{-}example.tar\textquotesingle{}} \DataTypeTok{\textbackslash{}}
...
\begin{figure}
\centering
\includegraphics{images/upload_api.png}
...
\hypertarget{option-3-upload-via-the-python-api}{%
...
\hypertarget{option-2-upload-via-docs-1}{%
\subsubsection{\texorpdfstring{Option 2: Upload via
