...
Step 0
\includegraphics{images/workflow-example.pdf}
\end{minipage} 
\ \
\begin{minipage}[b]{0.15\textwidth}
Step 0.5
\includegraphics{images/workflow-example-1.5.pdf} 
\end{minipage} \ \
\begin{minipage}[b]{0.15\textwidth}
Step 1 \includegraphics{images/workflow-example-2.pdf}
\end{minipage} 
\ \
\begin{minipage}[b]{0.15\textwidth}
Step 2
\includegraphics{images/workflow-example-3.pdf}

\end{minipage} 
\ \
\begin{minipage}[b]{0.15\textwidth}
Step 3 
\includegraphics{images/workflow-example-5.pdf}
\end{minipage} 
