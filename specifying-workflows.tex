...
providing sequences of names in a list such as \verb|-
start,fetch-data| or in our case where 3 more nodes are defined an
...
For shell and Slurm scripts \mintinline{bash}|.sh|, the script must
...
For Python scripts \mintinline{bash}|.py| and Jupyter
notebooks \mintinline{bash}|.ipynb|, the script it is easiiests to use
