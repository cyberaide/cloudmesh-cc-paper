...
GUI. Navigate to {\scriptsize \verb|http://127.0.0.1:8000/docs|}
and use the POST Upload method. Then click
{\em Try\ it\ out} and enter the
...
The view can also be achieved by opening the link \linebreak
{\scriptsize \verb|http://127.0.0.1:8000/|}.
...
example we will showcase here how to run is in the service mode by
either the GUI or a curl call.

\paragraph{GUI.} To run, navigate to homepage at
{\scriptsize \verb|http://127.0.0.1:8000/|} and click the workflow-example
on the left side. Then click Run.
