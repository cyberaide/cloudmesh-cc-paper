...
GUI. Navigate to {\scriptsize \texttt{http://127.0.0.1:8000/docs}} and use the POST
...
\bigskip
{\centering \includegraphics[width=1.0\columnwidth]{images/service-graph.png}
\vspace{-1.0cm}
...
{\scriptsize\texttt http://127.0.0.1:8000/} and click the workflow-example on the
...
\paragrap{Python request API.} To run the workflow with the Python
