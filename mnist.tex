...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{cms}\NormalTok{ set username=XXXXXX}
\end{Highlighting}
\end{Shaded}
...
\ExtensionTok{pytest} \AttributeTok{{-}v} \AttributeTok{{-}x} \AttributeTok{{-}{-}capture}\OperatorTok{=}\NormalTok{no examples/example\_run\_mnist\_workflow\_exec.py}
\end{Highlighting}
\end{Shaded}
