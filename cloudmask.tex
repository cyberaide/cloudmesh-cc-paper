...
\begin{figure}[htb]
  \resizebox{1.0\columnwidth}{!}{
   \digraph{cloudmaskwf}{
     ...
     start -> amd5095X;
     subgraph cluster_0 {
         label = "Compute Resource Desktop A";
     ...
     start -> "i9-9900K";
     subgraph cluster_1 {
         label = "Compute Resource Desktop B";
     ...
     start -> "connect vpn";
     subgraph cluster_2 {
         label = "Compute Resource Rivanna HPC";
      "connect vpn" -> "fetch data to rivanna" -> "v100 benchmark" -> "disconnect vpn";
      "fetch data to rivanna" -> "p100 benchmark" ->  "disconnect vpn";
      "fetch data to rivanna" -> "a100 benchmark" ->  "disconnect vpn";
      "fetch data to rivanna" -> "k80 benchmark" ->  "disconnect vpn";
      "fetch data to rivanna" -> "rtx2080 benchmark" ->  "disconnect vpn";
     }
     "disconnect vpn" -> end;  
    }
  }
